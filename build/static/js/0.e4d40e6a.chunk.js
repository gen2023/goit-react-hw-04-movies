  ...
  Array(50).concat([
        ...
        return new Promise(function (e, f) {
          ...
          if (t.auth) {
            var d = t.auth.username || '',
              y = t.auth.password || '';
            l.Authorization = 'Basic ' + btoa(d + ':' + y);
          }
    ...
    function (t, e, r) {
      var n = (function (t) {
        ...
        var m = (l.prototype = f.prototype = Object.create(h));
        function v(t) {
    ...
    function (t, e) {
      ...
      function l() {
        f &&
          c &&
          ((f = !1), c.length ? (s = c.concat(s)) : (p = -1), s.length && h());
      }
      function h() {
        if (!f) {
          var t = u(l);
